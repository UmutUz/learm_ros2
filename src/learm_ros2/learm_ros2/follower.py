...
# FUTURE: read the current robot position from controller and update memory state BTW does not work for LeArm apparently
servos = {
    ...
    "grip_left": xarm.Servo(1, -1),  # Flipped in URDF (open is close)
}
